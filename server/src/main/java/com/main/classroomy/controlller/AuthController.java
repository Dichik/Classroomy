...
import com.main.classroomy.entity.login.request.LoginRequest;
import com.main.classroomy.entity.login.request.SignupRequest;
import com.main.classroomy.entity.login.response.JwtResponse;
import com.main.classroomy.entity.login.response.MessageResponse;
...
import com.main.classroomy.security.jwt.JwtUtils;
    ...
    private void handleRoles(Set<String> requestRoles, Set<Role> roles) {
        requestRoles.forEach(role -> {
            if ("TEACHER".equalsIgnoreCase(role)) {
                Role managerRole = this.roleRepository.findByName(ERole.ROLE_TEACHER)
                        .orElseThrow(() -> new EntityNotFoundException("Error: Role is not found."));
